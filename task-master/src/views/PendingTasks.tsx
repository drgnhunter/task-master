  ...
  const pendingTasks: Task[] = [
    {
      ...
      description: "Complete section 3 and graph analysis",
      dueDate: "Sep 5, 2025, 11:59 PM",
      reminder: "Sep 5, 2025, 08:00 PM",
      priority: "Medium",
    },
  ];
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        <div className="mb-6">
          ...
          <p className="text-xs text-amber-600 font-medium mt-1">
            {pendingTasks.length} task remaining
          </p>
        </div>
        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200/90 rounded-lg text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition-all shadow-sm"
            />
          </div>
        ...
        <div className="space-y-3">
          {pendingTasks.map((task) => (
            <div
              key={task.id}
              className="bg-white rounded-2xl border border-gray-200/80 p-5 shadow-sm hover:shadow-md transition-shadow"
            >
              <div className="flex items-start justify-between">
                <div className="flex items-start space-x-3.5">
                  {/* Unchecked Action Circle */}
                  <button
